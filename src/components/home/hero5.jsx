                ...
                <div>
                    ...
                    <div className='grid grid-cols-2 md:grid-cols-4 gap-6 mt-10'>
                        <div>
                            ...
                            <p className='text-[7px] text-white'>Organizations Transformed.</p>
                        </div>

                         <div>
                            <h1 className='text-[#14B8A2] font-bold text-md'>15 +</h1>
                            <p className='text-[7px] text-white'>Years Experience</p>
                        </div>

                         <div>
                            <h1 className='text-[#14B8A2] font-bold text-md'>100 %</h1>
                            <p className='text-[7px] text-white'>Clients Satisfaction</p>
                        </div>

                         <div>
                            <h1 className='text-[#14B8A2] font-bold text-md'>10 +</h1>
                            <p className='text-[7px] text-white'>Industry Sectors</p>
                        </div>
                    </div>
                </div>
            </div>

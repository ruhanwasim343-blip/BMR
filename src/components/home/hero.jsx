        ...
        <>
            <div className='bg-[#15243D]'>
                <div className='grid grid-cols-1 md:grid-cols-12 max-w-7xl mx-auto px-5 sm:px-7 py-16 sm:py-20 gap-12 items-center'>
                    ...
                    <div className='col-span-7 text-center md:text-left'>
                        ...
                        <p className='text-[#D1D1D1] text-xs sm:text-base md:text-sm lg:text-base mt-6 sm:mt-8 leading-relaxed'>
                            ...
                            <span className='block'>
                                adopt AI responsibly, modernize delivery, and reduce risk.
                            </span>
                    ...
                    {/* Card */}
                    <Card className="col-span-5 bg-white relative overflow-hidden rounded-2xl w-full max-w-md mx-auto md:mx-0">
                        ...
                        <CardContent className="p-4 sm:p-6 lg:p-8 space-y-5">
                            ...
                            {/* Heading */}
                            <h1 className="text-lg sm:text-xl lg:text-2xl font-semibold text-gray-800 text-center md:text-left">
                                Outcome Snapshot
                            </h1>

...
export default function Hero3() {
    return (
        <>
            <div className='bg-[#0F1C33] lg:max-w-7xl px-6 py-12  mx-auto'>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
                    ...
                    {/* Card 2 */}
                    <div className='flex flex-col justify-center items-center text-center border border-[#E4E4E740]/80 rounded-lg p-6 space-y-3'>
                        <img className="w-8 h-8" src="/public/peopleicon.svg" alt="" />
                    ...
                    {/* Card 3 */}
                    <div className='flex flex-col justify-center items-center text-center border border-[#E4E4E740]/80 rounded-lg p-6 space-y-3'>
                        <img className="w-8 h-8" src="/public/verified.svg" alt="" />
                    ...
                    {/* Card 4 */}
                    <div className='flex flex-col justify-center items-center text-center border border-[#E4E4E740]/80 rounded-lg p-6 space-y-3'>
                        <img className="w-8 h-8" src="/public/Support.svg" alt="" />

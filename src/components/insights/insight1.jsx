...
export default function Insight1() {
    return (
        <>
            <div className='bg-[#15243D] max-w-7xl px-6 mx-auto py-12'>
                <div className='text-center space-y-3'>
                    <h1 className='text-2xl text-white font-bold'>Insights</h1>
                    <p className='text-[8px] text-[#99A1AF]'>Expert perspectives on responsible AI, governance frameworks, <span className='block'> transformation strategies, and leadership in the age of artificial intelligence.</span></p>
                </div>
